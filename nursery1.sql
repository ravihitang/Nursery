...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 11, 2023 at 09:26 AM
...
-- Procedures
--
CREATE DEFINER=`root`@`localhost` PROCEDURE `getPlant` ()  NO SQL SELECT * FROM tbl_plant$$

CREATE DEFINER=`root`@`localhost` PROCEDURE `getPlant1` ()  NO SQL SELECT * FROM tbl_order$$
...
(62, 4, 'deleted', '2023-01-11 13:39:40');
...
(12, 'Suhas', 'bindus', '187f091c2f9fa7021148b705ceaa1b7f'),
(13, 'as', 'ravi', 'ae2eb3a82aa8c5a706691b7fe9903421');
...
(1, 'Ravi ', '$2y$10$xfNWK5cnzMgMzeirTxDJBed7lv.FF7YTDroJ0VhWKWI18.RCNnc5y', 'hitangravi7@gmail.com', '2023-01-09 00:50:11'),
(2, 'admin', '$2y$10$xeL5mheztPD71DSAMThk3.7dl30zn8k1mP2vOcPvdr2IDG/yUcHOK', 'hitangavi7@gmail.com', '2023-01-09 00:52:29'),
(3, 'ananya', '$2y$10$rNMFZL43DSvQERXc7S6el.z1yOpzS22XWqn/LqKVVTQbw8FqJMb.C', 'ananya@gmail.com', '2023-01-09 01:04:41'),
(4, 'Chaitra', '$2y$10$.pgvFMvILOtbL/azsUeFUe49XBTNVlTSGpVq2LNtF0hdsR60qkUt.', 'chaitra@mail.com', '2023-01-09 06:41:05'),
(5, 'bindu', '$2y$10$48oNpogWk5KbVj5lyW6rquXFV7sDDtvZCAkElrikUQf2Gw.pT/uRS', 'bind@mail.com', '2023-01-10 19:36:27');
